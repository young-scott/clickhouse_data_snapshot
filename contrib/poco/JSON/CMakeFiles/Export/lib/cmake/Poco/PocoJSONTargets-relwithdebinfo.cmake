...
set_target_properties(Poco::JSON PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libPocoJSON.71.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libPocoJSON.71.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::JSON )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::JSON "${_IMPORT_PREFIX}/lib/libPocoJSON.71.dylib" )
